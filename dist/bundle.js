...
define("ResourceManager", ["require", "exports", "main"], function (require, exports, main_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
        ...
        ResourceManager.prototype.loadAssets = function (assets, onProcess, onComplete) {
            ...
            loader.on('progress', function (loader, evt) {
                ...
                if (evt.name.indexOf('/') > 0 && evt.type == PIXI.loaders.Resource.TYPE.XML) {
                    ...
                    if (ext == 'tsx') {
                        main_3._.lm.addTileset(result, evt.data);
                    }
                    if (ext == 'tmx') {
                        main_3._.lm.add(result, evt.data);
                    }
                }
...
define("Objects/Aligner", ["require", "exports", "Objects/O", "ClientSettings", "main"], function (require, exports, O_1, ClientSettings_1, main_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    ...
    var Aligner = /** @class */ (function (_super) {
        ...
        Aligner.prototype.init = function (props) {
            ...
            if (this.x - this.width / 2 < main_4._.screenCenterOffset[0]) {
                this.crossed[0] = -1;
            }
            if (this.x + this.width / 2 > main_4._.screenCenterOffset[0] + ClientSettings_1.MIN_SCR_WIDTH) {
                this.crossed[0] = 1;
            }
            if (this.y - this.height / 2 < main_4._.screenCenterOffset[1]) {
                this.crossed[1] = -1;
            }
            if (this.y + this.height / 2 > main_4._.screenCenterOffset[1] + ClientSettings_1.MIN_SCR_HEIGHT) {
                this.crossed[1] = 1;
            }
            var objectsUnderAligner = this.collectObjectsUnder(this);
            console.log("Objects under: ", objectsUnderAligner.length);
            var deltaX = main_4._.screenCenterOffset[0] * this.crossed[0];
            var deltaY = main_4._.screenCenterOffset[1] * this.crossed[1];
        ...
        Aligner.prototype.collectObjectsUnder = function (o) {
            var res = [];
            for (var _i = 0, _a = main_4._.lm.objectsList; _i < _a.length; _i++) {
                var x = _a[_i];
                if (x != o && (x.layer == main_4._.sm.gui || x.layer == main_4._.sm.gui2) && x.intersects(o)) {
                    res.push(x);
                }
            }
            return res;
...
define("Objects/IO", ["require", "exports", "main", "Objects/O"], function (require, exports, main_5, O_2) {
    ...
    var IO = /** @class */ (function (_super) {
        ...
        IO.prototype.init = function (props) {
            ...
            _super.prototype.init.call(this, props);
            var spr1 = main_5._.cs('Clock_Red.png');
            var spr2 = main_5._.cs('Clock_Red.png');
            spr1.scale.x = .33;
            spr1.scale.y = .33;
            spr2.scale.x = .33;
            spr2.scale.y = .33;
...
define("Objects/Camera", ["require", "exports", "Objects/O", "Math", "main"], function (require, exports, O_3, Math_2, main_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Camera = /** @class */ (function (_super) {
        ...
        function Camera(pos) {
            ...
            _this.rect = new PIXI.Rectangle(0, 0, main_6.SCR_WIDTH, main_6.SCR_HEIGHT);
            return _this;
        }
        Object.defineProperty(Camera.prototype, "zoom", {
            ...
            set: function (value) {
                this._zoom = value;
                var ofsx = main_6.SCR_WIDTH * (1 - this._zoom) / 2;
                var ofsy = main_6.SCR_HEIGHT * (1 - this._zoom) / 2;
                main_6._.sm.main.x = ofsx;
                main_6._.sm.main.y = ofsy;
                main_6._.sm.main.scale.x = value;
                main_6._.sm.main.scale.y = value;
                main_6._.sm.olgui.scale.x = value;
                main_6._.sm.olgui.scale.y = value;
                main_6._.sm.olgui.x = ofsx;
                main_6._.sm.olgui.y = ofsy;
                main_6._.sm.effects.scale.x = value;
                main_6._.sm.effects.scale.y = value;
                main_6._.sm.effects.x = ofsx;
                main_6._.sm.effects.y = ofsy;
            },
            enumerable: true,
            configurable: true
        });
        ...
        Camera.prototype.worldToScreen = function (s) {
            var centrObjCoordX = this.pos[0] - main_6.SCR_WIDTH * 0.5;
            var centrObjCoordY = this.pos[1] - main_6.SCR_HEIGHT * 0.5;
        ...
        Camera.prototype.process = function () {
            if (this.operator) {
                this.delta[0] = main_6._.fMath.cos(this.deltaAngle) * this.deltaLen / 7;
                this.delta[1] = main_6._.fMath.sin(this.deltaAngle) * this.deltaLen;
                this.deltaLen = main_6._.fMath.cos(main_6._.time / 1000 + this.deltaLen / 20) * 2;
                this.deltaAngle = main_6._.fMath.sin(main_6._.time / 2000 + this.deltaLen / 100) * 2;
            }
            this.offset[0] = this.pos[0] - main_6.SCR_WIDTH_HALF;
            this.offset[1] = this.pos[1] - main_6.SCR_HEIGHT_HALF;
            /*   if (this.a != 0) {
        ...
        Camera.prototype.isVisible = function (g) {
            ...
            return ((Math.abs(g.position.x - main_6.SCR_WIDTH_HALF - this.anchorDelta[0]) <= this.rect.width + main_6.SCR_WIDTH_HALF) && (Math.abs(g.position.y - main_6.SCR_HEIGHT_HALF - this.anchorDelta[1]) <= this.rect.height + main_6.SCR_HEIGHT_HALF));
        };
        ...
        Camera.prototype.worldScreenToUI = function (p) {
            p[0] -= main_6.SCR_WIDTH_HALF * (1 - this.zoom);
            p[1] -= main_6.SCR_HEIGHT_HALF * (1 - this.zoom);
            return p;
        };
...
define("Objects/BaseParticleSystem", ["require", "exports", "Objects/O", "main"], function (require, exports, O_4, main_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var BaseParticleSystem = /** @class */ (function (_super) {
        ...
        BaseParticleSystem.prototype.add = function (p, gfx) {
            ...
            this.processParticle(this.particles.length - 1, main_7._.delta);
            return p;
        };
        BaseParticleSystem.prototype.init = function (props) {
            _super.prototype.init.call(this, props);
            this.width = main_7.SCR_WIDTH;
            this.height = main_7.SCR_HEIGHT;
        ...
        BaseParticleSystem.prototype.process = function () {
            ...
            this.processParticles(main_7._.deltaSec * main_7._.timeScale);
            //TODO: WEIRD OVERRIDE VISIBLE
            this.gfx.visible = ((Math.abs(this.gfx.x - main_7.SCR_WIDTH_HALF + this.width / 2) <= this.width / 2 + main_7.SCR_WIDTH_HALF) &&
                (Math.abs(this.gfx.y - main_7.SCR_HEIGHT_HALF) <= this.height / 2 + main_7.SCR_HEIGHT_HALF));
        };
        return BaseParticleSystem;
    }(O_4.O));
    exports.BaseParticleSystem = BaseParticleSystem;
});
define("Objects/BlackScreen", ["require", "exports", "Objects/O", "main"], function (require, exports, O_5, main_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by KURWINDALLAS on 17.11.2014.
    ...
    var BlackScreen = /** @class */ (function (_super) {
        ...
        BlackScreen.prototype.init = function (props) {
            if (props.gfx) {
                this.gfx = main_8._.cs(props.gfx);
                this.gfx.x = main_8.SCR_WIDTH / 2;
                this.gfx.y = main_8.SCR_HEIGHT / 2;
                this.gfx.width = main_8.SCR_WIDTH;
                this.gfx.height = main_8.SCR_HEIGHT;
                this.gfx.alpha = 0.;
                new main_8._.TweenMax(this.gfx, 0.35, { alpha: 0.9 });
            }
            else {
                this.gfx = new PIXI.Graphics();
                this.gfx.clear();
                this.gfx.alpha = 0;
                new main_8._.TweenMax(this.gfx, 0.35, { alpha: 0.7 });
                this.gfx.beginFill(0x222222, 1);
                this.gfx.drawRect(0, 0, main_8.SCR_WIDTH, main_8.SCR_HEIGHT);
                this.gfx.endFill();
...
define("Objects/TextBox", ["require", "exports", "Objects/IO", "main"], function (require, exports, IO_1, main_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    ...
    var TextBox = /** @class */ (function (_super) {
        ...
        TextBox.prototype.init = function (props) {
            ...
            var gfx = this.layer ? this.layer : main_9._.sm.gui;
...
define("Objects/Button", ["require", "exports", "Objects/IO", "Objects/TextBox", "main"], function (require, exports, IO_2, TextBox_1, main_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Button = /** @class */ (function (_super) {
        ...
        Button.prototype.overAnimation = function (evt) {
            if (this.hoverMode) {
                if (this.doScale) {
                    main_10._.TweenMax.killTweensOf(this.gfx.scale);
                    new main_10._.TweenMax(this.gfx.scale, 0.08, { y: this.baseScale[1] + 0.03, ease: UIEase });
                    new main_10._.TweenMax(this.gfx.scale, 0.08, { x: this.baseScale[0] + 0.03, ease: UIEase });
                }
            }
            if (this._customOver)
                this._customOver();
        ...
        Button.prototype.outAnimation = function (evt) {
            if (this.hoverMode) {
                if (this.doScale) {
                    new main_10._.TweenMax(this.gfx.scale, 0.15, {
                        x: this.baseScale[0],
                        y: this.baseScale[1],
                        ease: Linear.easeOut
                    });
            ...
            this.gfx.mousedown = function (evt) {
                if (_this.hoverMode) {
                    ...
                    if (_this.clickAnimation) {
                        _this._upTween = main_10._.killTween(_this._upTween);
                        _this._downTween = new main_10._.TweenMax(_this, 0.1, { y: _this.y + CLICK_STEP, ease: Linear.easeIn });
                    }
                }
            };
        ...
        Button.prototype.onDestroy = function () {
            _super.prototype.onDestroy.call(this);
            this._downTween = main_10._.killTween(this._downTween);
            this._upTween = main_10._.killTween(this._upTween);
            if (this.gfx) {
        ...
        Button.prototype.highlight = function () {
            ...
            var loop = 0;
            if (this.__highlight)
                this.__highlight = main_10._.killTween(this.__highlight);
            this.__highlight = this.setInterval(function () {
                loop += 0.38;
                var angle = 0.5 * (main_10._.fMath.cos(loop) + 1);
            ...
            this.wait(0.12).call(function () {
                ...
                _this.__highlight = main_10._.killTween(_this.__highlight);
            }).apply();
        };
        Button.prototype.resetFade = function () {
            if (this.clickAnimation) {
                if (this._downTween) {
                    this._downTween = main_10._.killTween(this._downTween);
                    this._upTween = new main_10._.TweenMax(this, 0.1, { y: this.y - CLICK_STEP, ease: Linear.easeOut });
                }
            }
...
define("Objects/ParticleSystem", ["require", "exports", "Math", "main", "Objects/BaseParticleSystem"], function (require, exports, Math_3, main_11, BaseParticleSystem_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ParticleSystem = /** @class */ (function (_super) {
        ...
        ParticleSystem.prototype.init = function (props) {
            var _this = this;
            this.pos[0] -= main_11._.screenCenterOffset[0];
            this.pos[1] -= main_11._.screenCenterOffset[1];
            _super.prototype.init.call(this, props);
            this.gfx.width = main_11.SCR_WIDTH;
            this.gfx.height = main_11.SCR_HEIGHT;
            this.wind = [0, 0];
            var addPart = function (fixy) {
                if (fixy === void 0) { fixy = 0; }
                _this.addParticle(_this.pos[0] + Math.random() * main_11.SCR_WIDTH, _this.pos[1] + main_11._.screenCenterOffset[1] + 50 + fixy);
            };
        ...
        ParticleSystem.prototype.explode = function (p) {
            ...
            for (var _i = 0, _a = this.particles; _i < _a.length; _i++) {
                var x = _a[_i];
                var part = x;
                var worldx = this.pos[0] + x.x - main_11.SCR_WIDTH / 2;
                var worldy = this.pos[1] + x.y - main_11.SCR_HEIGHT / 2;
        ...
        ParticleSystem.prototype.processParticle = function (i, delta) {
            ...
            pobj.y += 0.15;
            var v = Math_3.m.rv2(this.wind, pobj.angle);
            pobj.av = pobj.av * 0.8 + 0.2 * ((Math.random() + 1) / 100);
            pobj.angle += pobj.av;
            //TODO: slow place
            var dx = main_11._.fMath.cos(pobj.angle);
            var dy = main_11._.fMath.sin(pobj.angle);
            pobj.alpha = (dy + 1) * 0.5;
            if (dy > 0.2 && dy < 0.35) {
                p.gotoAndStop(2);
            }
            ...
            pobj.y += (main_11.SCR_HEIGHT - p.y) / 10000;
            this.alwaysVisible = true;
        };
        ParticleSystem.prototype.process = function () {
            this.wind[0] = main_11._.fMath.cos(main_11._.time / 4000) * 60.8;
            this.wind[1] = main_11._.fMath.sin(main_11._.time / 4000) * 15.8;
            _super.prototype.process.call(this);
        };
...
define("ObjectsList", ["require", "exports", "Objects/Aligner", "Objects/BaseParticleSystem", "Objects/BlackScreen", "Objects/Button", "Objects/Camera", "Objects/IO", "Objects/O", "Objects/ParticleSystem", "Objects/TextBox"], function (require, exports, Aligner_1, BaseParticleSystem_2, BlackScreen_1, Button_1, Camera_1, IO_3, O_6, ParticleSystem_1, TextBox_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ObjectNames = {
        ...
        TextBox: TextBox_2.TextBox,
    };
    exports.LevelNames = [];
});
define("Stages/stage", ["require", "exports", "main"], function (require, exports, main_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    ...
    var Stage = /** @class */ (function () {
        ...
        Stage.prototype.onHide = function (newStage) {
            main_12._.sm.removeObjects();
            main_12._.sm.main.removeChild(this.container);
        };
        ;
        Stage.prototype.onShow = function () {
            main_12._.sm.main.addChild(this.container);
...
define("Stages/SM", ["require", "exports", "main", "Objects/Camera", "Math"], function (require, exports, main_13, Camera_2, Math_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    //asdasdasd
    var SM = /** @class */ (function () {
        ...
        SM.prototype.ZUpdate = function (container, c) {
            ...
            var l = Math_4.binarySearch(container.children, c, function (a, b) {
                return a.position.y - b.position.y;
            });
            if (l < 0) {
                l = ~l;
        ...
        SM.prototype.init = function () {
            ...
            var w = window;
            var ui = w.PIXI.UI;
            this.pixiUiStage = new ui.Stage(main_13.SCR_WIDTH, main_13.SCR_HEIGHT);
            ...
            main_13._.app.stage.addChild(this.superstage);
        };
        SM.prototype.createCamera = function () {
            this.camera = new Camera_2.Camera([main_13.SCR_WIDTH / 2, main_13.SCR_HEIGHT / 2]);
            return this.camera;
        };
        ...
        SM.prototype.fadeBegin = function (newStage) {
            ...
            this.camera.reset(main_13.SCR_WIDTH / 2, main_13.SCR_HEIGHT / 2, false);
            newStage.onShow();
        };
...
define("Stages/Menu", ["require", "exports", "Stages/stage"], function (require, exports, Stage_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("Stages/Game", ["require", "exports", "Stages/stage"], function (require, exports, Stage_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("main", ["require", "exports", "Sound", "PauseTimer", "lm", "lib/fmath", "ResourceManager", "ObjectsList", "ClientSettings", "Stages/SM", "Stages/Menu", "Stages/Game"], function (require, exports, Sound_1, PauseTimer_1, lm_1, FMath, ResourceManager_1, ObjectsList_1, ClientSettings_2, SM_1, Menu_1, Game_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Main = /** @class */ (function () {
        ...
        Main.prototype.setScreenRes = function (baseW, baseH) {
            this.appScale = baseH / ClientSettings_2.MIN_SCR_HEIGHT;
            ...
            this.screenCenterOffset = [(exports.SCR_WIDTH - ClientSettings_2.MIN_SCR_WIDTH) * .5, (exports.SCR_HEIGHT - ClientSettings_2.MIN_SCR_HEIGHT) * .5];
        };
...
define("Objects/O", ["require", "exports", "main", "utils/EventTypes"], function (require, exports, main_14, EventTypes_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var O = /** @class */ (function () {
        function O(pos, gfx) {
            ...
            this.createTime = main_14._.timer.getTimer();
            if (gfx) {
                this._gfx = gfx;
            }
            if (this.stringID) {
                main_14._.sm.globalIds[this.stringID] = this;
            }
            main_14._.sm.objects.push(this);
        }
        ...
        O.prototype.onDestroy = function () {
            ...
            if (this.trackObject) {
                main_14._.TweenMax.killTweensOf(this.trackObject);
                this.trackObject = null;
            }
            ...
            if (main_14._.debug && this.debugGfx) {
                O.rp(this.debugGfx);
                this.debugGfx = null;
            }
        };
        ...
        O.getSprite = function (texName) {
            if (texName.length > 4 && texName.charAt(texName.length - 4) != ".")
                ...
                add = "";
            var s = new main_14._.PIXI.Sprite(main_14._.PIXI.Texture.fromFrame(texName + add));
            s.anchor.x = 0.5;
            s.anchor.y = 0.5;
            return s;
        };
        ...
        O.prototype.init = function (props) {
            ...
            this.createTime = main_14._.timer.getTimer();
            if (this._gfx)
                main_14._.sm.camera.updateTransform(this, this._gfx, 0, 0);
            this.updateBounds();
        };
        ...
        O.prototype.setTimeout = function (f, delaySecs) {
            ...
            return main_14._.TweenMax.delayedCall(delaySecs, function () {
                if (_this.doRemove)
                    return -1;
                return f();
            });
        ...
        O.prototype.setIntervalTimeout = function (f, delaySecs, timeoutSecs) {
            ...
            main_14._.TweenMax.delayedCall(timeoutSecs, function () {
                ff = main_14._.killTween(ff);
            });
            return ff;
        };
        O.prototype.setInterval = function (f, delaySecs) {
            ...
            if (delaySecs < 0.03)
                delaySecs = 0.03;
            var interval = new main_14._.TimelineMax({ repeat: -1 }).call(function () {
                if (_this.doRemove)
                    return main_14._.killTween(interval);
                return f();
            }, null, null, delaySecs);
            return interval;
        };
        ...
        O.prototype.process = function () {
            ...
            if (this.av != 0)
                this.a += this.av * main_14._.worldSpeed * main_14._.delta;
            if (this._gfx)
                main_14._.sm.camera.updateTransform(this, this._gfx, 0, 0);
        };
...
define("lm", ["require", "exports", "Objects/O", "main", "Math", "ObjectsList"], function (require, exports, O_7, main_15, Math_5, ObjectsList_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var FLIPPED_HORIZONTALLY_FLAG = 0x80000000;
    var FLIPPED_VERTICALLY_FLAG = 0x40000000;
    var FLIPPED_DIAGONALLY_FLAG = 0x20000000;
    for (var x in ObjectsList_2.ObjectNames) {
        ObjectsList_2.ObjectNames[x.toLowerCase()] = ObjectsList_2.ObjectNames[x];
    }
    ...
    var InstanceType = /** @class */ (function () {
    ...
    var LM = /** @class */ (function () {
        ...
        LM.addGfxToWorld = function (stage, layerName) {
            if (layerName == 'gui')
                return main_15._.sm.gui;
            if (layerName == 'gui2')
                return main_15._.sm.gui2;
            if (layerName == 'olgui')
                return main_15._.sm.olgui;
        ...
        LM.prototype.createGfx = function (o, textureName, x, y, frameName, properties) {
            ...
            if (properties['movieclip'] == 'true') {
                ...
                gfx = main_15._.cm(noDigitsFrameName);
        ...
        LM.prototype.createObject = function (stage, o, textureName, offsetx, offsety, frameName, layerName, groupProps, flipX, flipY) {
            ...
            if (properties["singleton"] == 'true') {
                //UniqueCheck
                if (ObjectsList_2.ObjectNames[className] && main_15._.sm.findByType(ObjectsList_2.ObjectNames[className]).length > 0) {
                    return null;
                }
            }
            var obj;
            ...
            if (className != '') {
                if (!ObjectsList_2.ObjectNames[className]) {
                    console.log('[LevelManager] Cant find class: ', className);
                }
                obj = new (ObjectsList_2.ObjectNames[className])(startPos);
            }
            else {
                obj = new O_7.O(startPos);
            }
            obj.stringID = name;
            if (polygon) {
        ...
        LM.prototype.spawnTile = function (stage, textureName, posX, posY, layerName, type, layerStringID) {
            var sprite = main_15._.cs(textureName);
            sprite.anchor.x = 0.;
            sprite.anchor.y = 0.;
            var o;
            if (type && type != '') {
                o = new ObjectsList_2.ObjectNames[type.toLowerCase()]([posX, posY]);
            }
            else {
                o = new O_7.O([posX, posY]);
            }
        ...
        LM.prototype.createPolygon = function (o, polygon, properties) {
            ...
            main_15._.app.renderer.render(g, renderTexture);
...
function p() {
    ...
    b.isLong = function (a) { return !0 === (a && a.__isLong__); };
    var r = {}, s = {};
    ...
    b.fromNumber = function (a, c) {
        c = !!c;
        return isNaN(a) ||
            !isFinite(a) ? b.ZERO : !c && a <= -t ? b.MIN_VALUE : !c && a + 1 >= t ? b.MAX_VALUE : c && a >= u ? b.MAX_UNSIGNED_VALUE : 0 > a ? b.fromNumber(-a, c).negate() : new b(a % 4294967296 | 0, a / 4294967296 | 0, c);
    };
    ...
    b.fromValue = function (a) { return a instanceof b ? a : "number" === typeof a ? b.fromNumber(a) : "string" === typeof a ? b.fromString(a) : new b(a.low, a.high, a.unsigned); };
    ...
    b.prototype.getHighBits =
        function () { return this.high; };
    b.prototype.getHighBitsUnsigned = function () { return this.high >>> 0; };
    ...
    b.prototype.isNegative =
        function () { return !this.unsigned && 0 > this.high; };
    ...
    b.prototype.notEquals = function (a) { return !this.equals(a); };
    b.neq = b.prototype.notEquals;
    b.prototype.lessThan = function (a) { return 0 > this.compare(a); };
    b.prototype.lt = b.prototype.lessThan;
    b.prototype.lessThanOrEqual = function (a) { return 0 >= this.compare(a); };
    b.prototype.lte = b.prototype.lessThanOrEqual;
    b.prototype.greaterThan = function (a) { return 0 < this.compare(a); };
    ...
    b.prototype.divide = function (a) {
        ...
        for (d = this; d.greaterThanOrEqual(a);) {
            ...
            for (var f = Math.ceil(Math.log(c) /
                Math.LN2), f = 48 >= f ? 1 : Math.pow(2, f - 48), g = b.fromNumber(c), k = g.multiply(a); k.isNegative() || k.greaterThan(d);)
    ...
    b.prototype.modulo = function (a) { b.isLong(a) || (a = b.fromValue(a)); return this.subtract(this.divide(a).multiply(a)); };
    ...
    b.prototype.xor = function (a) { b.isLong(a) || (a = b.fromValue(a)); return b.fromBits(this.low ^ a.low, this.high ^ a.high, this.unsigned); };
...
define(["require", "exports", "../main", "./TextBox", "./Tooltip", "./SkillsPanel", "./O"], function (require, exports, main_1, TextBox_1, Tooltip_1, SkillsPanel_1, O_1) {
     ...
     */ ///
    var DEFAULT_FONT = 'smallfontp';
    var ColorTextBox = (function (_super) {
